...
export default function Instructors({instructor}: InstructorProps) {
  return (
    <div className="mb-7 xs:bg-[#EEF2F4] xs:pt-2 " id="instructor-section">
      <div className="pt-4 pb-2 bg-white">
        <h2 className="mb-4 text-xl font-semibold md:text-2xl">
          {instructor?.sectionName}
        </h2>
        <CardWrapper className="flex items-center">
          <div>
            <div
          ...
          <div className="flex-1 ml-4">
            <h3 className="text-lg flex items-center hover:text-green-600">
              {instructor?.name}
